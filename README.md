...
mengklik tombol hijau yang bertuliskan "code" lalu copy yang (HTTPS)
setelah itu masuk kedalam terminal lalu ketik
```
git clone https://github.com/DTLudlow/eprints-3.4.4-docker /eprints
```

lalu masuk kedalam folder e-prints
```
cd /home/eprints
```

lalu membuat container docker dengan mengetik 
```
...
Navigasi ke folder tempat eprints diinstal
```
cd /eprints
```

Jalankan eprint dengan
```
docker compose up -d
```
